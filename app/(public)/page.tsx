...
import { ArrowRight, MapPin, Instagram, Mail, Phone, Clock, Lock, X, Monitor, ShieldAlert } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#1A1A1A] text-[#F5F5F5] font-sans selection:bg-[#FBC02D] selection:text-black">
      ...
      {showAdminGate && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[#111] border border-[#333] w-full max-w-md p-8 rounded-3xl relative shadow-2xl space-y-6 text-center">
            <button
            ...
            <div className="w-16 h-16 bg-[#222] rounded-full flex items-center justify-center mx-auto mb-4 text-[#FBC02D]">
              <Lock size={32} />
            </div>

            <div>
              <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-2">Restricted Access</h3>
              <p className="text-gray-400 text-sm">Select your gateway credential level.</p>
            </div>

            <div className="grid grid-cols-1 gap-4 pt-4">
              <Link
                href="/login" // Login biasa / Staff
                className="group bg-[#222] hover:bg-[#333] border border-[#333] hover:border-[#FBC02D] p-4 rounded-xl flex items-center gap-4 transition-all text-left"
              >
                <div className="w-12 h-12 bg-black rounded-lg flex items-center justify-center text-gray-400 group-hover:text-[#FBC02D] group-hover:scale-110 transition-all">
                  <Monitor size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-white group-hover:text-[#FBC02D] uppercase">Point of Sales</h4>
                  <p className="text-xs text-gray-500">Staff & Cashier Access</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-white group-hover:text-[#FBC02D] uppercase">Super Admin</h4>
                  <p className="text-xs text-gray-500">System Management</p>
                </div>
              </Link>
            </div>

            <p className="text-[10px] text-gray-600 font-mono pt-4 uppercase tracking-widest">Confidential Area</p>
          </div>
        </div>
      )}
