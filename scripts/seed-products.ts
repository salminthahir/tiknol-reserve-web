...
const products = [
    ...
    { id: 'non_002', name: 'Coklat Milk', description: 'Susu coklat creamy.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: true, customizationOptions: { sizes: ['M', 'L'] } },
    ...
    { id: 'non_008', name: 'Coklat Vanilla', description: 'Perpaduan coklat dan vanilla.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: true, customizationOptions: { sizes: ['M', 'L'] } },
    { id: 'non_009', name: 'Coklat Caramel', description: 'Coklat dengan saus karamel.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: true, customizationOptions: { sizes: ['M', 'L'] } },
    { id: 'non_010', name: 'Coklat Hazelnut', description: 'Coklat dengan aroma hazelnut.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: true, customizationOptions: { sizes: ['M', 'L'] } },
    { id: 'non_011', name: 'Coklat Coconut', description: 'Coklat dengan rasa kelapa.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: true, customizationOptions: { sizes: ['M', 'L'] } },
    ...
    { id: 'non_013', name: 'Coklat Panas', description: 'Hot Chocolate.', price: 20000, category: 'Non-Coffee', image: 'https://images.unsplash.com/photo-1544787210-22bb830d5966', hasCustomization: false, customizationOptions: { temps: ['HOT'] } },
    ...
    // === MEALS ===
    { id: 'food_001', name: 'Nasi Chicken Teriyaki', description: 'Nasi dengan ayam saus teriyaki.', price: 23000, category: 'Meals', image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713', hasCustomization: false, customizationOptions: null },
    { id: 'food_002', name: 'Nasgor Tiknol', description: 'Nasi goreng spesial Tiknol.', price: 23000, category: 'Meals', image: 'https://images.unsplash.com/photo-1603133872878-684f10842619', hasCustomization: false, customizationOptions: null },
    { id: 'food_003', name: 'Nasgor Sambal Roa', description: 'Nasi goreng dengan sambal roa pedas.', price: 23000, category: 'Meals', image: 'https://images.unsplash.com/photo-1603133872878-684f10842619', hasCustomization: false, customizationOptions: null },
    { id: 'food_004', name: 'Nasi Chicken Garage', description: 'Nasi ayam spesial garage.', price: 23000, category: 'Meals', image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713', hasCustomization: false, customizationOptions: null },
    { id: 'food_005', name: 'Sate Taichan', description: 'Sate ayam putih dengan sambal pedas.', price: 23000, category: 'Meals', image: 'https://images.unsplash.com/photo-1593741683466-bbf3db08a33f', hasCustomization: false, customizationOptions: null },
    ...
    { id: 'food_008', name: 'Nasi Putih', description: 'Nasi putih tambahan.', price: 5000, category: 'Snacks', image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713', hasCustomization: false, customizationOptions: null },
    { id: 'food_009', name: 'Tahu Walik', description: 'Tahu goreng isi adonan daging/aci.', price: 18000, category: 'Snacks', image: 'https://images.unsplash.com/photo-1626109968837-a1691361c77e', hasCustomization: false, customizationOptions: null },
    { id: 'food_010', name: 'Pis-Gor Sambal Roa', description: 'Pisang goreng dicocol sambal roa.', price: 23000, category: 'Snacks', image: 'https://images.unsplash.com/photo-1626109968837-a1691361c77e', hasCustomization: false, customizationOptions: null },
    { id: 'food_011', name: 'Kentang Goreng', description: 'French fries original.', price: 18000, category: 'Snacks', image: 'https://images.unsplash.com/photo-1630384060421-a4323ceca041', hasCustomization: false, customizationOptions: null },
    { id: 'food_012', name: 'Cheese Roll', description: 'Keju gulung goreng renyah.', price: 13000, category: 'Snacks', image: 'https://images.unsplash.com/photo-1630384060421-a4323ceca041', hasCustomization: false, customizationOptions: null },
